...
class JsonEventParserTest {
    ...
    void testSimpleStringFromMap() {
        ...
        jsonRoot.tokens().forEach(t -> System.out.println(t));

        StringNode aStringValue = jsonRoot.getObjectNode().getStringNode("a");
        assertEquals("a", jsonRoot.getObjectNode().getString("a"));
        assertEquals("a", aStringValue.toString());
        assertEquals("a", jsonRoot.getObjectNode().getString("a"));
        ...
        assertEquals(niceJson("a"), jsonRoot.getObjectNode().getString("a"));
